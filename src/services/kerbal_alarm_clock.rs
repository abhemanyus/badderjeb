...
impl Alarm {
    ...
    /// <doc> <summary> The action that the alarm triggers. </summary> </doc>
    pub fn set_action(&self, p_value: super::kerbal_alarm_clock::AlarmAction) -> CallHandle<()> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("KerbalAlarmClock"));
    ...
    /// <doc> <summary> The vessel that the alarm is attached to. </summary> </doc>
    pub fn set_vessel(&self, p_value: super::space_center::Vessel) -> CallHandle<()> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("KerbalAlarmClock"));
...
pub fn alarm_with_name(p_name: String) -> CallHandle<super::kerbal_alarm_clock::Alarm> {
    let mut proc_call = krpc::ProcedureCall::new();
    proc_call.set_service(String::from("KerbalAlarmClock"));
...
pub fn get_alarms() -> CallHandle<Vec<super::kerbal_alarm_clock::Alarm>> {
    let mut proc_call = krpc::ProcedureCall::new();
    proc_call.set_service(String::from("KerbalAlarmClock"));
