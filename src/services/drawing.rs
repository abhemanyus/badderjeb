...
impl Text {
    ...
    pub fn available_fonts() -> CallHandle<Vec<String>> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("Drawing"));
    ...
    /// <doc> <summary> Alignment. </summary> </doc>
    pub fn set_alignment(&self, p_value: super::ui::TextAlignment) -> CallHandle<()> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("Drawing"));
    ...
    /// <doc> <summary> Anchor. </summary> </doc>
    pub fn set_anchor(&self, p_value: super::ui::TextAnchor) -> CallHandle<()> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("Drawing"));
