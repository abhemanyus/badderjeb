...
impl Canvas {
    ...
    pub fn add_button(&self, p_content: String, p_visible: bool) -> CallHandle<super::ui::Button> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("UI"));
    ...
    pub fn add_input_field(&self, p_visible: bool) -> CallHandle<super::ui::InputField> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("UI"));
    ...
    pub fn add_panel(&self, p_visible: bool) -> CallHandle<super::ui::Panel> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("UI"));
    ...
    pub fn add_text(&self, p_content: String, p_visible: bool) -> CallHandle<super::ui::Text> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("UI"));
...
impl Text {
    ...
    /// <doc> <summary> Alignment. </summary> </doc>
    pub fn set_alignment(&self, p_value: super::ui::TextAnchor) -> CallHandle<()> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("UI"));
    ...
    /// <doc> <summary> Font style. </summary> </doc>
    pub fn set_style(&self, p_value: super::ui::FontStyle) -> CallHandle<()> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("UI"));
...
pub fn add_canvas() -> CallHandle<super::ui::Canvas> {
    let mut proc_call = krpc::ProcedureCall::new();
    proc_call.set_service(String::from("UI"));
...
pub fn get_stock_canvas() -> CallHandle<super::ui::Canvas> {
    let mut proc_call = krpc::ProcedureCall::new();
    proc_call.set_service(String::from("UI"));
