...
impl AlarmManager {
    ...
    pub fn add_alarm(p_time: f64, p_title: String, p_description: String) -> CallHandle<super::space_center::Alarm> {
        ...
        let mut arg0 = krpc::Argument::new();
        arg0.set_position(0);
        arg0.set_value(p_time.encode_to_bytes().unwrap());
        arguments.push(arg0);
        ...
        arg2.set_position(2);
        arg2.set_value(p_description.encode_to_bytes().unwrap());
        arguments.push(arg2);
        proc_call.set_arguments(arguments);
    ...
    pub fn add_apoapsis_alarm(p_vessel: super::space_center::Vessel, p_offset: f64, p_title: String, p_description: String) -> CallHandle<super::space_center::Alarm> {
        ...
        let mut arg1 = krpc::Argument::new();
        arg1.set_position(1);
        arg1.set_value(p_offset.encode_to_bytes().unwrap());
        arguments.push(arg1);

        let mut arg2 = krpc::Argument::new();
        arg2.set_position(2);
        arg2.set_value(p_title.encode_to_bytes().unwrap());
        arguments.push(arg2);

        let mut arg3 = krpc::Argument::new();
        arg3.set_position(3);
        arg3.set_value(p_description.encode_to_bytes().unwrap());
        arguments.push(arg3);
        proc_call.set_arguments(arguments);
    ...
    pub fn add_maneuver_node_alarm(p_vessel: super::space_center::Vessel, p_node: super::space_center::Node, p_offset: f64, p_add_burn_time: bool, p_title: String, p_description: String) -> CallHandle<super::space_center::Alarm> {
        ...
        let mut arg1 = krpc::Argument::new();
        arg1.set_position(1);
        arg1.set_value(p_node.encode_to_bytes().unwrap());
        arguments.push(arg1);

        let mut arg2 = krpc::Argument::new();
        arg2.set_position(2);
        arg2.set_value(p_offset.encode_to_bytes().unwrap());
        arguments.push(arg2);

        let mut arg3 = krpc::Argument::new();
        arg3.set_position(3);
        arg3.set_value(p_add_burn_time.encode_to_bytes().unwrap());
        arguments.push(arg3);

        let mut arg4 = krpc::Argument::new();
        arg4.set_position(4);
        arg4.set_value(p_title.encode_to_bytes().unwrap());
        arguments.push(arg4);

        let mut arg5 = krpc::Argument::new();
        arg5.set_position(5);
        arg5.set_value(p_description.encode_to_bytes().unwrap());
        arguments.push(arg5);
        proc_call.set_arguments(arguments);
    ...
    pub fn add_vessel_alarm(p_time: f64, p_vessel: super::space_center::Vessel, p_title: String, p_description: String) -> CallHandle<super::space_center::Alarm> {
        ...
        let mut arg1 = krpc::Argument::new();
        arg1.set_position(1);
        arg1.set_value(p_vessel.encode_to_bytes().unwrap());
        arguments.push(arg1);
...
impl AutoPilot {
    ...
    /// <doc> <summary> The current <see cref="T:SpaceCenter.SASMode" />. These modes are equivalent to the mode buttons to the left of the navball that appear when SAS is enabled. </summary> <remarks>Equivalent to <see cref="M:SpaceCenter.Control.SASMode" /></remarks> </doc>
    pub fn set_sas_mode(&self, p_value: super::space_center::SASMode) -> CallHandle<()> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("SpaceCenter"));
...
impl Camera {
    ...
    /// <doc> <summary> In map mode, the celestial body that the camera is focussed on. Returns <c>null</c> if the camera is not focussed on a celestial body. Returns an error is the camera is not in map mode. </summary> </doc>
    pub fn set_focussed_body(&self, p_value: super::space_center::CelestialBody) -> CallHandle<()> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("SpaceCenter"));
    ...
    /// <doc> <summary> In map mode, the maneuver node that the camera is focussed on. Returns <c>null</c> if the camera is not focussed on a maneuver node. Returns an error is the camera is not in map mode. </summary> </doc>
    pub fn set_focussed_node(&self, p_value: super::space_center::Node) -> CallHandle<()> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("SpaceCenter"));
    ...
    /// <doc> <summary> In map mode, the vessel that the camera is focussed on. Returns <c>null</c> if the camera is not focussed on a vessel. Returns an error is the camera is not in map mode. </summary> </doc>
    pub fn set_focussed_vessel(&self, p_value: super::space_center::Vessel) -> CallHandle<()> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("SpaceCenter"));
    ...
    /// <doc> <summary> The current mode of the camera. </summary> </doc>
    pub fn set_mode(&self, p_value: super::space_center::CameraMode) -> CallHandle<()> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("SpaceCenter"));
...
impl Control {
    ...
    /// <doc> <summary> The state of CustomAxis01. A value between -1 and 1. </summary> </doc>
    pub fn set_custom_axis01(&self, p_value: f32) -> CallHandle<()> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("SpaceCenter"));
        proc_call.set_procedure(String::from("Control_set_CustomAxis01"));
    ...
    /// <doc> <summary> The state of CustomAxis02. A value between -1 and 1. </summary> </doc>
    pub fn set_custom_axis02(&self, p_value: f32) -> CallHandle<()> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("SpaceCenter"));
        proc_call.set_procedure(String::from("Control_set_CustomAxis02"));
    ...
    /// <doc> <summary> The state of CustomAxis03. A value between -1 and 1. </summary> </doc>
    pub fn set_custom_axis03(&self, p_value: f32) -> CallHandle<()> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("SpaceCenter"));
        proc_call.set_procedure(String::from("Control_set_CustomAxis03"));
    ...
    /// <doc> <summary> The state of CustomAxis04. A value between -1 and 1. </summary> </doc>
    pub fn set_custom_axis04(&self, p_value: f32) -> CallHandle<()> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("SpaceCenter"));
        proc_call.set_procedure(String::from("Control_set_CustomAxis04"));
    ...
    /// <doc> <summary> Sets the behavior of the pitch, yaw, roll and translation control inputs. When set to additive, these inputs are added to the vessels current inputs. This mode is the default. When set to override, these inputs (if non-zero) override the vessels inputs. This mode prevents keyboard control, or SAS, from interfering with the controls when they are set. </summary> </doc>
    pub fn set_input_mode(&self, p_value: super::space_center::ControlInputMode) -> CallHandle<()> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("SpaceCenter"));
    ...
    /// <doc> <summary> The current <see cref="T:SpaceCenter.SpeedMode" /> of the navball. This is the mode displayed next to the speed at the top of the navball. </summary> </doc>
    pub fn set_speed_mode(&self, p_value: super::space_center::SpeedMode) -> CallHandle<()> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("SpaceCenter"));
...
impl CrewMember {
    ...
    /// <doc> <summary> The crew member's suit type. </summary> </doc>
    pub fn set_suit_type(&self, p_value: super::space_center::SuitType) -> CallHandle<()> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("SpaceCenter"));
        proc_call.set_procedure(String::from("CrewMember_set_SuitType"));
...
impl DockingPort {
    ...
    /// <doc> <summary> Lock rotation. When locked, allows auto-strut to work across the joint. </summary> </doc>
    pub fn set_rotation_locked(&self, p_value: bool) -> CallHandle<()> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("SpaceCenter"));
        proc_call.set_procedure(String::from("DockingPort_set_RotationLocked"));
    ...
    /// <doc> <summary> Rotation target angle in degrees. </summary> </doc>
    pub fn set_rotation_target(&self, p_value: f32) -> CallHandle<()> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("SpaceCenter"));
        proc_call.set_procedure(String::from("DockingPort_set_RotationTarget"));
...
#[allow(dead_code)]
impl Engine {
    /// <doc> <summary> The amount of thrust, in Newtons, that would be produced by the engine when activated and with its throttle set to 100%. Returns zero if the engine does not have any fuel. Takes the given pressure into account. </summary> <param name="pressure">Atmospheric pressure in atmospheres</param> </doc>
    pub fn available_thrust_at(&self, p_pressure: f64) -> CallHandle<f32> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("SpaceCenter"));
        proc_call.set_procedure(String::from("Engine_AvailableThrustAt"));
        ...
        let mut arg1 = krpc::Argument::new();
        arg1.set_position(1);
        arg1.set_value(p_pressure.encode_to_bytes().unwrap());
        arguments.push(arg1);
        proc_call.set_arguments(arguments);

        CallHandle::new(proc_call)
    }
    /// <doc> <summary> The amount of thrust, in Newtons, that would be produced by the engine when activated and fueled, with its throttle and throttle limiter set to 100%. Takes the given pressure into account. </summary> <param name="pressure">Atmospheric pressure in atmospheres</param> </doc>
    pub fn max_thrust_at(&self, p_pressure: f64) -> CallHandle<f32> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("SpaceCenter"));
        proc_call.set_procedure(String::from("Engine_MaxThrustAt"));
    ...
    /// <doc> <summary> The specific impulse of the engine under the given pressure, in seconds. Returns zero if the engine is not active. </summary> <param name="pressure">Atmospheric pressure in atmospheres</param> </doc>
    pub fn specific_impulse_at(&self, p_pressure: f64) -> CallHandle<f32> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("SpaceCenter"));
        proc_call.set_procedure(String::from("Engine_SpecificImpulseAt"));
    ...
    /// <doc> <summary> Whether the independent throttle is enabled for the engine. </summary> </doc>
    pub fn set_independent_throttle(&self, p_value: bool) -> CallHandle<()> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("SpaceCenter"));
        proc_call.set_procedure(String::from("Engine_set_IndependentThrottle"));
    ...
    pub fn set_throttle(&self, p_value: f32) -> CallHandle<()> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("SpaceCenter"));
        proc_call.set_procedure(String::from("Engine_set_Throttle"));
...
impl fmt::Debug for LaunchSite {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "LaunchSite({})", self.id)
    }
}
...
impl Light {
    ...
    /// <doc> <summary> Whether blinking is enabled. </summary> </doc>
    pub fn set_blink(&self, p_value: bool) -> CallHandle<()> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("SpaceCenter"));
        proc_call.set_procedure(String::from("Light_set_Blink"));
    ...
    /// <doc> <summary> The blink rate of the light. </summary> </doc>
    pub fn set_blink_rate(&self, p_value: f32) -> CallHandle<()> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("SpaceCenter"));
        proc_call.set_procedure(String::from("Light_set_BlinkRate"));
...
#[allow(dead_code)]
impl Module {
    /// <doc> <summary> Returns the value of a field with the given name. </summary> <param name="name">Name of the field.</param> </doc>
    ...
    /// <doc> <summary> Returns the value of a field with the given identifier. </summary> <param name="id">Identifier of the field.</param> </doc>
    pub fn get_field_by_id(&self, p_id: String) -> CallHandle<String> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("SpaceCenter"));
        proc_call.set_procedure(String::from("Module_GetFieldById"));
        ...
        let mut arg1 = krpc::Argument::new();
        arg1.set_position(1);
        arg1.set_value(p_id.encode_to_bytes().unwrap());
        arguments.push(arg1);
        proc_call.set_arguments(arguments);
    ...
    /// <doc> <summary><c>true</c> if the part has an action with the given identifier. </summary> <param name="id"></param> </doc>
    pub fn has_action_with_id(&self, p_id: String) -> CallHandle<bool> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("SpaceCenter"));
        proc_call.set_procedure(String::from("Module_HasActionWithId"));
    ...
    /// <doc> <summary><c>true</c> if the module has an event with the given identifier. </summary> <param name="id"></param> </doc>
    pub fn has_event_with_id(&self, p_id: String) -> CallHandle<bool> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("SpaceCenter"));
        proc_call.set_procedure(String::from("Module_HasEventWithId"));
    ...
    /// <doc> <summary> Returns <c>true</c> if the module has a field with the given identifier. </summary> <param name="id">Identifier of the field.</param> </doc>
    pub fn has_field_with_id(&self, p_id: String) -> CallHandle<bool> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("SpaceCenter"));
        proc_call.set_procedure(String::from("Module_HasFieldWithId"));
    ...
    /// <doc> <summary> Set the value of a field to its original value. </summary> <param name="id">Identifier of the field.</param> </doc>
    pub fn reset_field_by_id(&self, p_id: String) -> CallHandle<()> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("SpaceCenter"));
        proc_call.set_procedure(String::from("Module_ResetFieldById"));
    ...
    /// <doc> <summary> Set the value of an action with the given identifier. </summary> <param name="id"></param> <param name="value"></param> </doc>
    pub fn set_action_by_id(&self, p_id: String, p_value: bool) -> CallHandle<()> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("SpaceCenter"));
        proc_call.set_procedure(String::from("Module_SetActionById"));
    ...
    /// <doc> <summary> Set the value of a field to true or false. </summary> <param name="name">Name of the field.</param> <param name="value">Value to set.</param> </doc>
    pub fn set_field_bool(&self, p_name: String, p_value: bool) -> CallHandle<()> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("SpaceCenter"));
        proc_call.set_procedure(String::from("Module_SetFieldBool"));
    ...
    /// <doc> <summary> Set the value of a field to true or false. </summary> <param name="id">Identifier of the field.</param> <param name="value">Value to set.</param> </doc>
    pub fn set_field_bool_by_id(&self, p_id: String, p_value: bool) -> CallHandle<()> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("SpaceCenter"));
        proc_call.set_procedure(String::from("Module_SetFieldBoolById"));
    ...
    /// <doc> <summary> Set the value of a field to the given floating point number. </summary> <param name="id">Identifier of the field.</param> <param name="value">Value to set.</param> </doc>
    pub fn set_field_float_by_id(&self, p_id: String, p_value: f32) -> CallHandle<()> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("SpaceCenter"));
        proc_call.set_procedure(String::from("Module_SetFieldFloatById"));
    ...
    /// <doc> <summary> Set the value of a field to the given integer number. </summary> <param name="id">Identifier of the field.</param> <param name="value">Value to set.</param> </doc>
    pub fn set_field_int_by_id(&self, p_id: String, p_value: i32) -> CallHandle<()> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("SpaceCenter"));
        proc_call.set_procedure(String::from("Module_SetFieldIntById"));
    ...
    /// <doc> <summary> Set the value of a field to the given string. </summary> <param name="id">Identifier of the field.</param> <param name="value">Value to set.</param> </doc>
    pub fn set_field_string_by_id(&self, p_id: String, p_value: String) -> CallHandle<()> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("SpaceCenter"));
        proc_call.set_procedure(String::from("Module_SetFieldStringById"));
    ...
    /// <doc> <summary> Trigger the event with the given identifier. Equivalent to clicking the button in the right-click menu of the part. </summary> <param name="id"></param> </doc>
    pub fn trigger_event_by_id(&self, p_id: String) -> CallHandle<()> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("SpaceCenter"));
        proc_call.set_procedure(String::from("Module_TriggerEventById"));
...
impl Orbit {
    ...
    pub fn relative_inclination(&self, p_target: super::space_center::Orbit) -> CallHandle<f64> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("SpaceCenter"));
    ...
    pub fn true_anomaly_at_an(&self, p_target: super::space_center::Orbit) -> CallHandle<f64> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("SpaceCenter"));
    ...
    pub fn true_anomaly_at_dn(&self, p_target: super::space_center::Orbit) -> CallHandle<f64> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("SpaceCenter"));
...
impl Part {
    ...
    /// <doc> <summary> The asset URL for the part's flag. </summary> </doc>
    pub fn set_flag_url(&self, p_value: String) -> CallHandle<()> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("SpaceCenter"));
        proc_call.set_procedure(String::from("Part_set_FlagURL"));
    ...
    /// <doc> <summary> Whether the part is glowing. </summary> </doc>
    pub fn set_glow(&self, p_value: bool) -> CallHandle<()> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("SpaceCenter"));
        proc_call.set_procedure(String::from("Part_set_Glow"));
...
impl Parts {
    ...
    pub fn in_decouple_stage(&self, p_stage: i32) -> CallHandle<Vec<super::space_center::Part>> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("SpaceCenter"));
    ...
    pub fn in_stage(&self, p_stage: i32) -> CallHandle<Vec<super::space_center::Part>> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("SpaceCenter"));
    ...
    pub fn with_module(&self, p_module_name: String) -> CallHandle<Vec<super::space_center::Part>> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("SpaceCenter"));
    ...
    pub fn with_name(&self, p_name: String) -> CallHandle<Vec<super::space_center::Part>> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("SpaceCenter"));
    ...
    pub fn with_tag(&self, p_tag: String) -> CallHandle<Vec<super::space_center::Part>> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("SpaceCenter"));
    ...
    pub fn with_title(&self, p_title: String) -> CallHandle<Vec<super::space_center::Part>> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("SpaceCenter"));
    ...
    /// <doc> <summary> The part from which the vessel is controlled. </summary> </doc>
    pub fn set_controlling(&self, p_value: super::space_center::Part) -> CallHandle<()> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("SpaceCenter"));
...
impl ResourceConverter {
    ...
    pub fn state(&self, p_index: i32) -> CallHandle<super::space_center::ResourceConverterState> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("SpaceCenter"));
...
impl fmt::Debug for ResourceDrain {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "ResourceDrain({})", self.id)
    }
}
...
#[allow(dead_code)]
impl ResourceDrain {
    /// <doc> <summary> Whether the provided resource is enabled for draining. </summary> </doc>
    pub fn check_resource(&self, p_resource: super::space_center::Resource) -> CallHandle<bool> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("SpaceCenter"));
        proc_call.set_procedure(String::from("ResourceDrain_CheckResource"));
        ...
        let mut arg1 = krpc::Argument::new();
        arg1.set_position(1);
        arg1.set_value(p_resource.encode_to_bytes().unwrap());
        arguments.push(arg1);
        proc_call.set_arguments(arguments);
    ...
    pub fn set_resource(&self, p_resource: super::space_center::Resource, p_enabled: bool) -> CallHandle<()> {
        ...
        let mut arg2 = krpc::Argument::new();
        arg2.set_position(2);
        arg2.set_value(p_enabled.encode_to_bytes().unwrap());
        arguments.push(arg2);
        proc_call.set_arguments(arguments);
    ...
    /// <doc> <summary> The drain mode. </summary> </doc>
    pub fn set_drain_mode(&self, p_value: super::space_center::DrainMode) -> CallHandle<()> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("SpaceCenter"));
        proc_call.set_procedure(String::from("ResourceDrain_set_DrainMode"));
    ...
    /// <doc> <summary> Current drain rate. </summary> </doc>
    pub fn set_rate(&self, p_value: f32) -> CallHandle<()> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("SpaceCenter"));
        proc_call.set_procedure(String::from("ResourceDrain_set_Rate"));
...
impl Resources {
    ...
    pub fn density(p_name: String) -> CallHandle<f32> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("SpaceCenter"));
    ...
    pub fn flow_mode(p_name: String) -> CallHandle<super::space_center::ResourceFlowMode> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("SpaceCenter"));
    ...
    pub fn with_resource(&self, p_name: String) -> CallHandle<Vec<super::space_center::Resource>> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("SpaceCenter"));
...
impl fmt::Debug for RoboticController {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "RoboticController({})", self.id)
    }
}
...
impl RoboticController {
    ...
    pub fn add_axis(&self, p_module: super::space_center::Module, p_field_name: String) -> CallHandle<bool> {
        ...
        let mut arg1 = krpc::Argument::new();
        arg1.set_position(1);
        arg1.set_value(p_module.encode_to_bytes().unwrap());
        arguments.push(arg1);

        let mut arg2 = krpc::Argument::new();
        arg2.set_position(2);
        arg2.set_value(p_field_name.encode_to_bytes().unwrap());
        arguments.push(arg2);
        proc_call.set_arguments(arguments);
    ...
    pub fn add_key_frame(&self, p_module: super::space_center::Module, p_field_name: String, p_time: f32, p_value: f32) -> CallHandle<bool> {
        ...
        let mut arg3 = krpc::Argument::new();
        arg3.set_position(3);
        arg3.set_value(p_time.encode_to_bytes().unwrap());
        arguments.push(arg3);

        let mut arg4 = krpc::Argument::new();
        arg4.set_position(4);
        arg4.set_value(p_value.encode_to_bytes().unwrap());
        arguments.push(arg4);
        proc_call.set_arguments(arguments);
    ...
    /// <doc> <summary> Whether the controller has a part. </summary> </doc>
    pub fn has_part(&self, p_part: super::space_center::Part) -> CallHandle<bool> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("SpaceCenter"));
        proc_call.set_procedure(String::from("RoboticController_HasPart"));
        ...
        let mut arg1 = krpc::Argument::new();
        arg1.set_position(1);
        arg1.set_value(p_part.encode_to_bytes().unwrap());
        arguments.push(arg1);
        proc_call.set_arguments(arguments);
...
impl fmt::Debug for RoboticHinge {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "RoboticHinge({})", self.id)
    }
}
...
impl RoboticHinge {
    ...
    /// <doc> <summary> Damping percentage. </summary> </doc>
    pub fn set_damping(&self, p_value: f32) -> CallHandle<()> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("SpaceCenter"));
        proc_call.set_procedure(String::from("RoboticHinge_set_Damping"));
    ...
    /// <doc> <summary> Lock movement. </summary> </doc>
    pub fn set_locked(&self, p_value: bool) -> CallHandle<()> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("SpaceCenter"));
        proc_call.set_procedure(String::from("RoboticHinge_set_Locked"));
    ...
    /// <doc> <summary> Whether the motor is engaged. </summary> </doc>
    pub fn set_motor_engaged(&self, p_value: bool) -> CallHandle<()> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("SpaceCenter"));
        proc_call.set_procedure(String::from("RoboticHinge_set_MotorEngaged"));
    ...
    pub fn set_rate(&self, p_value: f32) -> CallHandle<()> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("SpaceCenter"));
        proc_call.set_procedure(String::from("RoboticHinge_set_Rate"));
    ...
    /// <doc> <summary> Target angle. </summary> </doc>
    pub fn set_target_angle(&self, p_value: f32) -> CallHandle<()> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("SpaceCenter"));
        proc_call.set_procedure(String::from("RoboticHinge_set_TargetAngle"));
...
impl fmt::Debug for RoboticPiston {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "RoboticPiston({})", self.id)
    }
}
...
impl RoboticPiston {
    ...
    pub fn set_damping(&self, p_value: f32) -> CallHandle<()> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("SpaceCenter"));
        proc_call.set_procedure(String::from("RoboticPiston_set_Damping"));
    ...
    pub fn set_locked(&self, p_value: bool) -> CallHandle<()> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("SpaceCenter"));
        proc_call.set_procedure(String::from("RoboticPiston_set_Locked"));
    ...
    pub fn set_motor_engaged(&self, p_value: bool) -> CallHandle<()> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("SpaceCenter"));
        proc_call.set_procedure(String::from("RoboticPiston_set_MotorEngaged"));
    ...
    pub fn set_rate(&self, p_value: f32) -> CallHandle<()> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("SpaceCenter"));
        proc_call.set_procedure(String::from("RoboticPiston_set_Rate"));
    ...
    /// <doc> <summary> Target extension of the piston. </summary> </doc>
    pub fn set_target_extension(&self, p_value: f32) -> CallHandle<()> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("SpaceCenter"));
        proc_call.set_procedure(String::from("RoboticPiston_set_TargetExtension"));
...
impl fmt::Debug for RoboticRotation {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "RoboticRotation({})", self.id)
    }
}
...
impl RoboticRotation {
    ...
    pub fn set_damping(&self, p_value: f32) -> CallHandle<()> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("SpaceCenter"));
        proc_call.set_procedure(String::from("RoboticRotation_set_Damping"));
    ...
    pub fn set_locked(&self, p_value: bool) -> CallHandle<()> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("SpaceCenter"));
        proc_call.set_procedure(String::from("RoboticRotation_set_Locked"));
    ...
    pub fn set_motor_engaged(&self, p_value: bool) -> CallHandle<()> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("SpaceCenter"));
        proc_call.set_procedure(String::from("RoboticRotation_set_MotorEngaged"));
    ...
    pub fn set_rate(&self, p_value: f32) -> CallHandle<()> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("SpaceCenter"));
        proc_call.set_procedure(String::from("RoboticRotation_set_Rate"));
    ...
    pub fn set_target_angle(&self, p_value: f32) -> CallHandle<()> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("SpaceCenter"));
        proc_call.set_procedure(String::from("RoboticRotation_set_TargetAngle"));
...
impl fmt::Debug for RoboticRotor {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "RoboticRotor({})", self.id)
    }
}
...
impl RoboticRotor {
    ...
    pub fn set_inverted(&self, p_value: bool) -> CallHandle<()> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("SpaceCenter"));
        proc_call.set_procedure(String::from("RoboticRotor_set_Inverted"));
    ...
    pub fn set_locked(&self, p_value: bool) -> CallHandle<()> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("SpaceCenter"));
        proc_call.set_procedure(String::from("RoboticRotor_set_Locked"));
    ...
    pub fn set_motor_engaged(&self, p_value: bool) -> CallHandle<()> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("SpaceCenter"));
        proc_call.set_procedure(String::from("RoboticRotor_set_MotorEngaged"));
    ...
    /// <doc> <summary> Target RPM. </summary> </doc>
    pub fn set_target_rpm(&self, p_value: f32) -> CallHandle<()> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("SpaceCenter"));
        proc_call.set_procedure(String::from("RoboticRotor_set_TargetRPM"));
    ...
    /// <doc> <summary> Torque limit percentage. </summary> </doc>
    pub fn set_torque_limit(&self, p_value: f32) -> CallHandle<()> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("SpaceCenter"));
        proc_call.set_procedure(String::from("RoboticRotor_set_TorqueLimit"));
...
impl Vessel {
    ...
    /// <doc> <summary> Gets the total available thrust that can be produced by the vessel's active engines, in Newtons. This is computed by summing <see cref="M:SpaceCenter.Engine.AvailableThrustAt" /> for every active engine in the vessel. Takes the given pressure into account. </summary> <param name="pressure">Atmospheric pressure in atmospheres</param> </doc>
    pub fn available_thrust_at(&self, p_pressure: f64) -> CallHandle<f32> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("SpaceCenter"));
        proc_call.set_procedure(String::from("Vessel_AvailableThrustAt"));
    ...
    /// <doc> <summary> The total maximum thrust that can be produced by the vessel's active engines, in Newtons. This is computed by summing <see cref="M:SpaceCenter.Engine.MaxThrustAt" /> for every active engine. Takes the given pressure into account. </summary> <param name="pressure">Atmospheric pressure in atmospheres</param> </doc>
    pub fn max_thrust_at(&self, p_pressure: f64) -> CallHandle<f32> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("SpaceCenter"));
        proc_call.set_procedure(String::from("Vessel_MaxThrustAt"));
    ...
    /// <doc> <summary> The combined specific impulse of all active engines, in seconds. This is computed using the formula <a href="https://wiki.kerbalspaceprogram.com/wiki/Specific_impulse#Multiple_engines">described here</a>. Takes the given pressure into account. </summary> <param name="pressure">Atmospheric pressure in atmospheres</param> </doc>
    pub fn specific_impulse_at(&self, p_pressure: f64) -> CallHandle<f32> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("SpaceCenter"));
        proc_call.set_procedure(String::from("Vessel_SpecificImpulseAt"));
    ...
    /// <doc> <summary> The type of the vessel. </summary> </doc>
    pub fn set_type(&self, p_value: super::space_center::VesselType) -> CallHandle<()> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("SpaceCenter"));
...
impl Waypoint {
    ...
    /// <doc> <summary> The celestial body the waypoint is attached to. </summary> </doc>
    pub fn set_body(&self, p_value: super::space_center::CelestialBody) -> CallHandle<()> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("SpaceCenter"));
...
impl Wheel {
    ...
    /// <doc> <summary> The steering angle limit. </summary> </doc>
    pub fn set_steering_angle_limit(&self, p_value: f32) -> CallHandle<()> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("SpaceCenter"));
        proc_call.set_procedure(String::from("Wheel_set_SteeringAngleLimit"));
    ...
    /// <doc> <summary> Steering response time. </summary> </doc>
    pub fn set_steering_response_time(&self, p_value: f32) -> CallHandle<()> {
        let mut proc_call = krpc::ProcedureCall::new();
        proc_call.set_service(String::from("SpaceCenter"));
        proc_call.set_procedure(String::from("Wheel_set_SteeringResponseTime"));
...
impl From<i32> for AutoStrutMode {
    #[inline]
    fn from(source: i32) -> Self {
        match source {
            0 => AutoStrutMode::Off,
            1 => AutoStrutMode::Root,
            2 => AutoStrutMode::Heaviest,
            3 => AutoStrutMode::Grandparent,
...
#[derive(Debug, Copy, Clone)]
pub enum CrewMemberGender {
    Male = 0,
    Female = 1,
}

impl From<i32> for CrewMemberGender {
    #[inline]
    fn from(source: i32) -> Self {
        match source {
...
impl From<i32> for DrainMode {
    #[inline]
    fn from(source: i32) -> Self {
        match source {
            0 => DrainMode::Part,
            1 => DrainMode::Vessel,
            _ => panic!("Could not convert '{}' to a SpaceCenter::DrainMode", source),
        }
    }
}
...
#[derive(Debug, Copy, Clone)]
pub enum EditorFacility {
    VAB = 1,
    SPH = 2,
    None = 0,
}

impl From<i32> for EditorFacility {
    #[inline]
    fn from(source: i32) -> Self {
        match source {
...
impl From<i32> for MapFilterType {
    #[inline]
    fn from(source: i32) -> Self {
        match source {
            -1 => MapFilterType::All,
            0 => MapFilterType::None,
            1 => MapFilterType::Debris,
            2 => MapFilterType::Unknown,
            4 => MapFilterType::SpaceObjects,
            8 => MapFilterType::Probes,
            16 => MapFilterType::Rovers,
            32 => MapFilterType::Landers,
            64 => MapFilterType::Ships,
            128 => MapFilterType::Stations,
            256 => MapFilterType::Bases,
            512 => MapFilterType::EVAs,
            1024 => MapFilterType::Flags,
            2048 => MapFilterType::Plane,
...
impl From<i32> for RosterStatus {
    #[inline]
    fn from(source: i32) -> Self {
        match source {
            0 => RosterStatus::Available,
...
impl From<i32> for SuitType {
    ...
    fn from(source: i32) -> Self {
        match source {
            ...
            2 => SuitType::Future,
            3 => SuitType::Slim,
            _ => panic!("Could not convert '{}' to a SpaceCenter::SuitType", source),
        }
    }
}
...
impl From<i32> for VesselType {
    ...
    fn from(source: i32) -> Self {
        match source {
            ...
            9 => VesselType::SpaceObject,
            10 => VesselType::Unknown,
            11 => VesselType::EVA,
            12 => VesselType::Flag,
            13 => VesselType::DeployedScienceController,
...
#[allow(dead_code)]
/// <doc> <summary> Whether the current flight can be reverted to launch. </summary> </doc>
pub fn can_revert_to_launch() -> CallHandle<bool> {
    let mut proc_call = krpc::ProcedureCall::new();
    proc_call.set_service(String::from("SpaceCenter"));
    proc_call.set_procedure(String::from("CanRevertToLaunch"));
...
#[allow(dead_code)]
/// <doc> <summary> Creates a Kerbal. </summary> <param name="name"></param> <param name="job"></param> <param name="male"></param> </doc>
pub fn create_kerbal(p_name: String, p_job: String, p_male: bool) -> CallHandle<()> {
    let mut proc_call = krpc::ProcedureCall::new();
    proc_call.set_service(String::from("SpaceCenter"));
    proc_call.set_procedure(String::from("CreateKerbal"));
    ...
    let mut arg1 = krpc::Argument::new();
    arg1.set_position(1);
    arg1.set_value(p_job.encode_to_bytes().unwrap());
    arguments.push(arg1);

    let mut arg2 = krpc::Argument::new();
    arg2.set_position(2);
    arg2.set_value(p_male.encode_to_bytes().unwrap());
    arguments.push(arg2);
    proc_call.set_arguments(arguments);
...
#[allow(dead_code)]
/// <doc> <summary> Find a Kerbal by name. </summary> <param name="name"></param> <returns><c>null</c> if no Kerbal with the given name exists.</returns> </doc>
pub fn get_kerbal(p_name: String) -> CallHandle<super::space_center::CrewMember> {
    let mut proc_call = krpc::ProcedureCall::new();
    proc_call.set_service(String::from("SpaceCenter"));
    proc_call.set_procedure(String::from("GetKerbal"));
...
pub fn launch_vessel(p_craft_directory: String, p_name: String, p_launch_site: String, p_recover: bool, p_crew: Vec<String>, p_flag_url: String) -> CallHandle<()> {
    ...
    let mut arg4 = krpc::Argument::new();
    arg4.set_position(4);
    arg4.set_value(p_crew.encode_to_bytes().unwrap());
    arguments.push(arg4);

    let mut arg5 = krpc::Argument::new();
    arg5.set_position(5);
    arg5.set_value(p_flag_url.encode_to_bytes().unwrap());
    arguments.push(arg5);
    proc_call.set_arguments(arguments);
...
#[allow(dead_code)]
/// <doc> <summary> Load the game with the given name. This will create a load a save file called <c>name.sfs</c> from the folder of the current save game. </summary> <param name="name">Name of the save.</param> </doc>
...
#[allow(dead_code)]
/// <doc> <summary> Switch to the space center view. </summary> </doc>
pub fn load_space_center() -> CallHandle<()> {
    let mut proc_call = krpc::ProcedureCall::new();
    proc_call.set_service(String::from("SpaceCenter"));
    proc_call.set_procedure(String::from("LoadSpaceCenter"));
...
#[allow(dead_code)]
/// <doc> <summary> Revert the current flight to launch. </summary> </doc>
pub fn revert_to_launch() -> CallHandle<()> {
    let mut proc_call = krpc::ProcedureCall::new();
    proc_call.set_service(String::from("SpaceCenter"));
    proc_call.set_procedure(String::from("RevertToLaunch"));

    CallHandle::new(proc_call)
}

#[allow(dead_code)]
/// <doc> <summary> Save the game with a given name. This will create a save file called <c>name.sfs</c> in the folder of the current save game. </summary> <param name="name">Name of the save.</param> </doc>
...
#[allow(dead_code)]
/// <doc> <summary> Saves a screenshot. </summary> <param name="filePath">The path of the file to save.</param> <param name="scale">Resolution scaling factor</param> </doc>
pub fn screenshot(p_file_path: String, p_scale: i32) -> CallHandle<()> {
    let mut proc_call = krpc::ProcedureCall::new();
    proc_call.set_service(String::from("SpaceCenter"));
    proc_call.set_procedure(String::from("Screenshot"));

    let mut arguments = protobuf::RepeatedField::<krpc::Argument>::new();

    let mut arg0 = krpc::Argument::new();
    arg0.set_position(0);
    arg0.set_value(p_file_path.encode_to_bytes().unwrap());
    arguments.push(arg0);

    let mut arg1 = krpc::Argument::new();
    arg1.set_position(1);
    arg1.set_value(p_scale.encode_to_bytes().unwrap());
    arguments.push(arg1);
    proc_call.set_arguments(arguments);
...
pub fn transfer_crew(p_crew_member: super::space_center::CrewMember, p_target_part: super::space_center::Part) -> CallHandle<()> {
    ...
    let mut arg0 = krpc::Argument::new();
    arg0.set_position(0);
    arg0.set_value(p_crew_member.encode_to_bytes().unwrap());
    arguments.push(arg0);

    let mut arg1 = krpc::Argument::new();
    arg1.set_position(1);
    arg1.set_value(p_target_part.encode_to_bytes().unwrap());
    arguments.push(arg1);
    proc_call.set_arguments(arguments);
...
pub fn get_active_vessel() -> CallHandle<super::space_center::Vessel> {
    let mut proc_call = krpc::ProcedureCall::new();
    proc_call.set_service(String::from("SpaceCenter"));
...
#[allow(dead_code)]
/// <doc> <summary> The alarm manager. </summary> </doc>
pub fn get_alarm_manager() -> CallHandle<super::space_center::AlarmManager> {
    let mut proc_call = krpc::ProcedureCall::new();
    proc_call.set_service(String::from("SpaceCenter"));
    proc_call.set_procedure(String::from("get_AlarmManager"));
...
pub fn get_camera() -> CallHandle<super::space_center::Camera> {
    let mut proc_call = krpc::ProcedureCall::new();
    proc_call.set_service(String::from("SpaceCenter"));
...
pub fn get_contract_manager() -> CallHandle<super::space_center::ContractManager> {
    let mut proc_call = krpc::ProcedureCall::new();
    proc_call.set_service(String::from("SpaceCenter"));
...
pub fn get_game_mode() -> CallHandle<super::space_center::GameMode> {
    let mut proc_call = krpc::ProcedureCall::new();
    proc_call.set_service(String::from("SpaceCenter"));
...
#[allow(dead_code)]
/// <doc> <summary> A list of available launch sites. </summary> </doc>
pub fn get_launch_sites() -> CallHandle<Vec<super::space_center::LaunchSite>> {
    let mut proc_call = krpc::ProcedureCall::new();
    proc_call.set_service(String::from("SpaceCenter"));
    proc_call.set_procedure(String::from("get_LaunchSites"));

    CallHandle::new(proc_call)
}

#[allow(dead_code)]
/// <doc> <summary> The visible objects in map mode. </summary> </doc>
pub fn get_map_filter() -> CallHandle<super::space_center::MapFilterType> {
    let mut proc_call = krpc::ProcedureCall::new();
    proc_call.set_service(String::from("SpaceCenter"));
    proc_call.set_procedure(String::from("get_MapFilter"));
...
pub fn get_target_body() -> CallHandle<super::space_center::CelestialBody> {
    let mut proc_call = krpc::ProcedureCall::new();
    proc_call.set_service(String::from("SpaceCenter"));
...
pub fn get_target_docking_port() -> CallHandle<super::space_center::DockingPort> {
    let mut proc_call = krpc::ProcedureCall::new();
    proc_call.set_service(String::from("SpaceCenter"));
...
pub fn get_target_vessel() -> CallHandle<super::space_center::Vessel> {
    let mut proc_call = krpc::ProcedureCall::new();
    proc_call.set_service(String::from("SpaceCenter"));
...
pub fn get_vessels() -> CallHandle<Vec<super::space_center::Vessel>> {
    let mut proc_call = krpc::ProcedureCall::new();
    proc_call.set_service(String::from("SpaceCenter"));
...
pub fn get_warp_mode() -> CallHandle<super::space_center::WarpMode> {
    let mut proc_call = krpc::ProcedureCall::new();
    proc_call.set_service(String::from("SpaceCenter"));
...
pub fn get_waypoint_manager() -> CallHandle<super::space_center::WaypointManager> {
    let mut proc_call = krpc::ProcedureCall::new();
    proc_call.set_service(String::from("SpaceCenter"));
...
#[allow(dead_code)]
/// <doc> <summary> The currently active vessel. </summary> </doc>
pub fn set_active_vessel(p_value: super::space_center::Vessel) -> CallHandle<()> {
    let mut proc_call = krpc::ProcedureCall::new();
    proc_call.set_service(String::from("SpaceCenter"));
...
#[allow(dead_code)]
/// <doc> <summary> The visible objects in map mode. </summary> </doc>
pub fn set_map_filter(p_value: super::space_center::MapFilterType) -> CallHandle<()> {
    let mut proc_call = krpc::ProcedureCall::new();
    proc_call.set_service(String::from("SpaceCenter"));
    proc_call.set_procedure(String::from("set_MapFilter"));
...
#[allow(dead_code)]
/// <doc> <summary> The currently targeted celestial body. </summary> </doc>
pub fn set_target_body(p_value: super::space_center::CelestialBody) -> CallHandle<()> {
    let mut proc_call = krpc::ProcedureCall::new();
    proc_call.set_service(String::from("SpaceCenter"));
...
#[allow(dead_code)]
/// <doc> <summary> The currently targeted docking port. </summary> </doc>
pub fn set_target_docking_port(p_value: super::space_center::DockingPort) -> CallHandle<()> {
    let mut proc_call = krpc::ProcedureCall::new();
    proc_call.set_service(String::from("SpaceCenter"));
...
#[allow(dead_code)]
/// <doc> <summary> The currently targeted vessel. </summary> </doc>
pub fn set_target_vessel(p_value: super::space_center::Vessel) -> CallHandle<()> {
    let mut proc_call = krpc::ProcedureCall::new();
    proc_call.set_service(String::from("SpaceCenter"));
